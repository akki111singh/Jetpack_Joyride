  ...
  #include "ring.h"
  using namespace std;
  Rings::Rings(float x, float y,float r, color_t color,color_t color2,int n) {
      ...
      glPointSize(3);
      this->object = create3DObject(GL_TRIANGLES,3*n,g_vertex_buffer_data, this->color, GL_POINT);
